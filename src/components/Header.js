  ...
  return (
    <div className='flex justify-between'>
      ...
      <div className='flex gap-2'>
        <img alt='profileLogo' src={selector?.photoURL} className='rounded-md h-12 w-12'></img>
        <div>
          ...
          {showBtn && <button onClick={handleSignOut} className='text-white bg-red-500 rounded-md ml-2 p-0.5'>Log Out</button>}
        </div>
      </div>
    </div>
  )
