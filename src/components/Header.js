...
const Header = () => {
  ...
  return (
    <div className="flex fixed top-0 h-[10vh] md:h-[22vh] bg-gradient-to-b from-black p-2 w-screen md:w-full z-20">
      ...
      <div>
        <button onClick={handleToggle} className="relative top-1.5 md:top-2 left-[30vh] md:left-[148vh] inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-600 to-black group-hover:from-red-600 group-hover:to-black hover:text-white dark:text-white  focus:outline-none dark:focus:ring-red">
      ...
      <div className="md:flex md:gap-2 absolute right-2 top-4">
        <img
          ...
          className="rounded-md ml-[50%] md:ml-0 h-5 md:h-10 md:w-10"
        ></img>
        <div>
          <button
